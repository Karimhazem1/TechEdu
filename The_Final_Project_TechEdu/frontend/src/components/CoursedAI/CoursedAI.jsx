    ...
    return (
        <>
            ...
            <div className='cour-display' id='c-display'>
                ...
                {(() => {
                    const activeCourses = courses.filter(item => item.status === 'Active' && item.categoryCourse === "Artificial Intelligence");
                    return (
                        <>
